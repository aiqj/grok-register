...
from grok_register.export.cpa_xai import existing_cpa_emails, mint_and_export, parse_accounts_file  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument(
        "--accounts",
        default=str(_ROOT / "accounts" / "accounts_cli.txt"),
    )
    ap.add_argument(
        "--out-dir",
        default=str(_ROOT / "exports" / "cpa"),
    ...
    ap.add_argument(
        "--fail-log",
        default=str(_ROOT / "exports" / "cpa" / "backfill_failed.jsonl"),
